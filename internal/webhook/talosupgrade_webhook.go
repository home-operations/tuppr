...
func (v *TalosUpgradeValidator) ValidateCreate(ctx context.Context, talos *tupprv1alpha1.TalosUpgrade) (admission.Warnings, error) {
...
func (v *TalosUpgradeValidator) ValidateUpdate(ctx context.Context, oldTalos, talos *tupprv1alpha1.TalosUpgrade) (admission.Warnings, error) {
...
func (v *TalosUpgradeValidator) ValidateDelete(ctx context.Context, talos *tupprv1alpha1.TalosUpgrade) (admission.Warnings, error) {
