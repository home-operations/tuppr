...
![Version](https://img.shields.io/static/v1?label=Version&message=0.5.4&color=informational&style=flat-square) <!-- x-release-please-version -->
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
![AppVersion](https://img.shields.io/static/v1?label=AppVersion&message=0.5.4&color=informational&style=flat-square) <!-- x-release-please-version -->
...
| controller.logLevel | string | `"debug"` | Controller log level. `debug` also switches to console-formatted output. tuppr never logs at warn, so `warn` and `error` both emit only errors. |
